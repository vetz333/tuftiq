      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview {{($prefix == '/category')? 'active':''}} ">
          ...
          <ul class="treeview-menu">
            <li class="{{($route == 'all.category')? 'active' : ''}}" ><a href="{{route('all.category')}}"><i class="ti-more"></i>View Category</a></li>
            <li class="{{($route == 'add.category')? 'active' : ''}}"><a href="{{route('add.category')}}"><i class="ti-more"></i>Add New Category</a></li>
          </ul>
        </li>
